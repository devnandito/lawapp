...
from lawapp.users.views import dashboard, show_user, create_user, edit_user, delete_user, set_pwd, change_pwd, show_profile, create_profile, delete_profile, edit_profile
app_name = 'lawapp.users'
