...
list_label = {
    ...
    'Nombre': ['Descripcion', 'fa fa-address-card-o'],
    ...
    'Title': ['Ley', 'fa fa-address-card-o'],
    'Num': ['Numero', 'fa fa-address-card-o'],
    'Fklaw': ['Ley', 'fa fa-address-card-o'],
    'Chapter': ['Capitulo', 'fa fa-address-card-o'],
    'Fkchapter': ['Capitulo', 'fa fa-address-card-o'],
}
